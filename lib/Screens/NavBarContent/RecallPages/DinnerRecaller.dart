...
class DinnerRecaller extends StatefulWidget {
  const DinnerRecaller({Key? key}) : super(key: key);

  @override
  State<DinnerRecaller> createState() => _DinnerRecallerState();
}

class _DinnerRecallerState extends State<DinnerRecaller> {
  User? user = FirebaseAuth.instance.currentUser!;
  final fb = FirebaseDatabase.instance;
  var l, g, k;
  @override
  Widget build(BuildContext context) {
    final ref = fb.ref().child('${user!.uid}/dinner');
